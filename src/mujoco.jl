...
function activate(filename::String)
   ccall((:mj_activate,:libmujoco141nogl),Cint,(Cstring,),filename)
end

# deactivate license, free memory
function deactivate()
   ccall((:mj_deactivate,:libmujoco141nogl),Void,())
end
...
function loadXML(filename::String,xmlstring::String) #,error::String,error_sz::Integer)
   ...
   if length(xmlstring) == 0
      m=ccall((:mj_loadXML,:libmujoco141nogl),Ptr{mjModel},(Cstring,Cstring,Ptr{UInt8},Cint),filename,C_NULL,err,errsz)
   else
      m=ccall((:mj_loadXML,:libmujoco141nogl),Ptr{mjModel},(Cstring,Cstring,Ptr{UInt8},Cint),filename,xmlstring,err,errsz)
   end
   if m == C_NULL
      err[end] = 0;
...
function saveXML(filename::String,m::Ptr{mjModel},error::String,error_sz::Integer)
   ccall((:mj_saveXML,:libmujoco141nogl),Cint,(Cstring,Ptr{mjModel},Cstring,Cint),filename,m,error,error_sz)
end

# print internal XML schema as plain text or HTML, with style-padding or &nbsp;
function printSchema(filename::String,buffer::String,buffer_sz::Integer,flg_html::Integer,flg_pad::Integer)
   ccall((:mj_printSchema,:libmujoco141nogl),Cint,(Cstring,Cstring,Cint,Cint,Cint),filename,buffer,buffer_sz,flg_html,flg_pad)
end
...
function step(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_step,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# advance simulation in two steps: before external force/control is set by user
function step1(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_step1,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# advance simulation in two steps: after external force/control is set by user
function step2(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_step2,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# forward dynamics
function forward(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_forward,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# inverse dynamics
function inverse(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_inverse,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# forward dynamics with skip; skipstage is mjtStage
function forwardSkip(m::Ptr{mjModel},d::Ptr{mjData},skipstage::Integer,skipsensorenergy::Integer)
   ccall((:mj_forwardSkip,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Cint),m,d,skipstage,skipsensorenergy)
end

# inverse dynamics with skip; skipstage is mjtStage
function inverseSkip(m::Ptr{mjModel},d::Ptr{mjData},skipstage::Integer,skipsensorenergy::Integer)
   ccall((:mj_inverseSkip,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Cint),m,d,skipstage,skipsensorenergy)
end
...
function defaultSolRefImp(solref::Ptr{mjtNum},solimp::Ptr{mjtNum})
   ccall((:mj_defaultSolRefImp,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum}),solref,solimp)
end

# set physics options to default values
function defaultOption(opt::Ptr{mjOption})
   ccall((:mj_defaultOption,:libmujoco141nogl),Void,(Ptr{mjOption},),opt)
end

# set visual options to default values
function defaultVisual(vis::Ptr{mjVisual})
   ccall((:mj_defaultVisual,:libmujoco141nogl),Void,(Ptr{mjVisual},),vis)
end

# copy mjModel; allocate new if dest is NULL
function copyModel(dest::Ptr{mjModel},src::Ptr{mjModel})
   ccall((:mj_copyModel,:libmujoco141nogl),Ptr{mjModel},(Ptr{mjModel},Ptr{mjModel}),dest,src)
end
...
function saveModel(m::Ptr{mjModel},filename::String,buffer::Ptr{Void},buffer_sz::Integer)
   ccall((:mj_saveModel,:libmujoco141nogl),Void,(Ptr{mjModel},Cstring,Ptr{Void},Cint),m,filename,buffer,buffer_sz)
end
...
function loadModel(filename::String,buffer::Ptr{Void},buffer_sz::Integer)
   ccall((:mj_loadModel,:libmujoco141nogl),Ptr{mjModel},(Cstring,Ptr{Void},Cint),filename,buffer,buffer_sz)
end

# de-allocate model
function deleteModel(m::Ptr{mjModel})
   ccall((:mj_deleteModel,:libmujoco141nogl),Void,(Ptr{mjModel},),m)
end

# size of buffer needed to hold model
function sizeModel(m::Ptr{mjModel})
   ccall((:mj_sizeModel,:libmujoco141nogl),Cint,(Ptr{mjModel},),m)
end

# allocate mjData correponding to given model
function makeData(m::Ptr{mjModel})
   ccall((:mj_makeData,:libmujoco141nogl),Ptr{mjData},(Ptr{mjModel},),m)
end

# copy mjData
function copyData(dest::Ptr{mjData},m::Ptr{mjModel},src::Ptr{mjData})
   ccall((:mj_copyData,:libmujoco141nogl),Ptr{mjData},(Ptr{mjData},Ptr{mjModel},Ptr{mjData}),dest,m,src)
end

# set data to defaults
function resetData(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_resetData,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end
...
function resetDataDebug(m::Ptr{mjModel},d::Ptr{mjData},debug_value::Cuchar)
   ccall((:mj_resetDataDebug,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cuchar),m,d,debug_value)
end

# reset data, set fields from specified keyframe
function resetDataKeyframe(m::Ptr{mjModel},d::Ptr{mjData},key::Integer)
   ccall((:mj_resetDataKeyframe,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint),m,d,key)
end

# mjData stack allocate
function stackAlloc(d::Ptr{mjData},size::Integer)
   ccall((:mj_stackAlloc,:libmujoco141nogl),Ptr{mjtNum},(Ptr{mjData},Cint),d,size)
end

# de-allocate data
function deleteData(d::Ptr{mjData})
   ccall((:mj_deleteData,:libmujoco141nogl),Void,(Ptr{mjData},),d)
end

# reset callbacks to defaults
function resetCallbacks()
   ccall((:mj_resetCallbacks,:libmujoco141nogl),Void,())
end

# set constant fields of mjModel
function setConst(m::Ptr{mjModel},d::Ptr{mjData},flg_actrange::Integer)
   ccall((:mj_setConst,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint),m,d,flg_actrange)
end
...
function printModel(m::Ptr{mjModel},filename::String)
   ccall((:mj_printModel,:libmujoco141nogl),Void,(Ptr{mjModel},Cstring),m,filename)
end

# print data to text file
function printData(m::Ptr{mjModel},d::Ptr{mjData},filename::String)
   ccall((:mj_printData,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cstring),m,d,filename)
end

# print matrix to screen
function mju_printMat(mat::Ptr{mjtNum},nr::Integer,nc::Integer)
   ccall((:mju_printMat,:libmujoco141nogl),Void,(Ptr{mjtNum},Cint,Cint),mat,nr,nc)
end
...
function fwdPosition(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_fwdPosition,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# velocity-dependent computations
function fwdVelocity(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_fwdVelocity,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute actuator force
function fwdActuation(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_fwdActuation,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# add up all non-constraint forces, compute qacc_unc
function fwdAcceleration(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_fwdAcceleration,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# constraint solver
function fwdConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_fwdConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# Euler integrator, semi-implicit in velocity
function Euler(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_Euler,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# Runge-Kutta explicit order-N integrator
function RungeKutta(m::Ptr{mjModel},d::Ptr{mjData},N::Integer)
   ccall((:mj_RungeKutta,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint),m,d,N)
end
...
function invPosition(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_invPosition,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# velocity-dependent computations
function invVelocity(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_invVelocity,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# constraint solver
function invConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_invConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end
...
function compareFwdInv(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_compareFwdInv,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end
...
function sensorPos(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_sensorPos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# velocity-dependent sensors
function sensorVel(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_sensorVel,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# acceleration/force-dependent sensors
function sensorAcc(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_sensorAcc,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# position-dependent energy (potential)
function energyPos(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_energyPos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# velocity-dependent energy (kinetic)
function energyVel(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_energyVel,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end
...
function checkPos(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_checkPos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# check velocities; reset if bad
function checkVel(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_checkVel,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# check accelerations; reset if bad
function checkAcc(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_checkAcc,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# forward kinematics
function kinematics(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_kinematics,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# map inertias and motion dofs to global frame centered at CoM
function comPos(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_comPos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute camera and light positions and orientations
function camlight(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_camlight,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute tendon lengths, velocities and moment arms
function tendon(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_tendon,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute actuator transmission lengths and moments
function transmission(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_transmission,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# composite rigid body inertia algorithm
function crb(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_crb,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# sparse L'*D*L factorizaton of the inertia matrix
function factorM(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_factorM,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# sparse backsubstitution:  x = inv(L'*D*L)*y
function backsubM(m::Ptr{mjModel},d::Ptr{mjData},x::Ptr{mjtNum},y::Ptr{mjtNum},n::Integer)
   ccall((:mj_backsubM,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,x,y,n)
end
...
function backsubM2(m::Ptr{mjModel},d::Ptr{mjData},x::Ptr{mjtNum},y::Ptr{mjtNum},n::Integer)
   ccall((:mj_backsubM2,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,x,y,n)
end

# compute cvel, cdof_dot
function comVel(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_comVel,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# spring-dampers and body viscosity
function passive(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_passive,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# RNE: compute M(qpos)*qacc + C(qpos,qvel); flg_acc=0 removes inertial term
function rne(m::Ptr{mjModel},d::Ptr{mjData},flg_acc::Integer,result::Ptr{mjtNum})
   ccall((:mj_rne,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Ptr{mjtNum}),m,d,flg_acc,result)
end

# RNE with complete data: compute cacc, cfrc_ext, cfrc_int
function rnePostConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_rnePostConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# collision detection
function collision(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_collision,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# construct constraints
function makeConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_makeConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute dense matrices: efc_AR, e_ARchol, fc_half, fc_AR
function projectConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_projectConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end

# compute efc_vel, efc_aref
function referenceConstraint(m::Ptr{mjModel},d::Ptr{mjData})
   ccall((:mj_referenceConstraint,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData}),m,d)
end
...
function addContact(m::Ptr{mjModel},d::Ptr{mjData},con::Ptr{mjContact})
   ccall((:mj_addContact,:libmujoco141nogl),Cint,(Ptr{mjModel},Ptr{mjData},Ptr{mjContact}),m,d,con)
end

# determine type of friction cone
function isPyramid(m::Ptr{mjModel})
   ccall((:mj_isPyramid,:libmujoco141nogl),Cint,(Ptr{mjModel},),m)
end

# determine type of constraint Jacobian
function isSparse(m::Ptr{mjModel})
   ccall((:mj_isSparse,:libmujoco141nogl),Cint,(Ptr{mjModel},),m)
end

# multiply Jacobian by vector
function mulJacVec(m::Ptr{mjModel},d::Ptr{mjData},res::Ptr{mjtNum},vec::Ptr{mjtNum})
   ccall((:mj_mulJacVec,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum}),m,d,res,vec)
end

# multiply JacobianT by vector
function mulJacTVec(m::Ptr{mjModel},d::Ptr{mjData},res::Ptr{mjtNum},vec::Ptr{mjtNum})
   ccall((:mj_mulJacTVec,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum}),m,d,res,vec)
end
...
function jacBody(m::Ptr{mjModel},d::Ptr{mjData},jacp::Ptr{mjtNum},jacr::Ptr{mjtNum},body::Integer)
   ccall((:mj_jacBody,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,jacp,jacr,body)
end
...
function jacBodyCom(m::Ptr{mjModel},d::Ptr{mjData},jacp::Ptr{mjtNum},jacr::Ptr{mjtNum},body::Integer)
   ccall((:mj_jacBodyCom,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,jacp,jacr,body)
end

# compute geom Jacobian
function jacGeom(m::Ptr{mjModel},d::Ptr{mjData},jacp::Ptr{mjtNum},jacr::Ptr{mjtNum},geom::Integer)
   ccall((:mj_jacGeom,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,jacp,jacr,geom)
end

# compute site Jacobian
function jacSite(m::Ptr{mjModel},d::Ptr{mjData},jacp::Ptr{mjtNum},jacr::Ptr{mjtNum},site::Integer)
   ccall((:mj_jacSite,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Cint),m,d,jacp,jacr,site)
end
...
function name2id(m::Ptr{mjModel},_type::Integer,name::String)
   ccall((:mj_name2id,:libmujoco141nogl),Cint,(Ptr{mjModel},Cint,Cstring),m,_type,name)
end
...
function id2name(m::Ptr{mjModel},_type::Integer,id::Integer)
   ccall((:mj_id2name,:libmujoco141nogl),Cstring,(Ptr{mjModel},Cint,Cint),m,_type,id)
end

# convert sparse inertia matrix M into full matrix
function fullM(m::Ptr{mjModel},dst::Ptr{mjtNum},M::PtrVec)
   ccall((:mj_fullM,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjtNum},Ptr{mjtNum}),m,dst,M)
end
...
function applyFT(m::Ptr{mjModel},d::Ptr{mjData},force::Ptr{mjtNum},torque::Ptr{mjtNum},point::Ptr{mjtNum},body::Integer,qfrc_target::Ptr{mjtNum})
   ccall((:mj_applyFT,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Ptr{mjtNum}),m,d,force,torque,point,body,qfrc_target)
end
...
function objectVelocity(m::Ptr{mjModel},d::Ptr{mjData},objtype::Integer,objid::Integer,res::Ptr{mjtNum},flg_local::Integer)
   ccall((:mj_objectVelocity,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Cint,Ptr{mjtNum},Cint),m,d,objtype,objid,res,flg_local)
end
...
function objectAcceleration(m::Ptr{mjModel},d::Ptr{mjData},objtype::Integer,objid::Integer,res::Ptr{mjtNum},flg_local::Integer)
   ccall((:mj_objectAcceleration,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Cint,Ptr{mjtNum},Cint),m,d,objtype,objid,res,flg_local)
end

# compute velocity by finite-differencing two positions
function differentiatePos(m::Ptr{mjModel},qvel::Ptr{mjtNum},dt::mjtNum,qpos1::Ptr{mjtNum},qpos2::Ptr{mjtNum})
   ccall((:mj_differentiatePos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjtNum},mjtNum,Ptr{mjtNum},Ptr{mjtNum}),m,qvel,dt,qpos1,qpos2)
end

# extract 6D force:torque for one contact, in contact frame
function contactForce(m::Ptr{mjModel},d::Ptr{mjData},id::Integer,result::Ptr{mjtNum})
   ccall((:mj_contactForce,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,Ptr{mjtNum}),m,d,id,result)
end

# integrate position with given velocity
function integratePos(m::Ptr{mjModel},qpos::Ptr{mjtNum},qvel::Ptr{mjtNum},dt::mjtNum)
   ccall((:mj_integratePos,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjtNum},Ptr{mjtNum},mjtNum),m,qpos,qvel,dt)
end

# normalize all quaterions in qpos-type vector
function normalizeQuat(m::Ptr{mjModel},qpos::Ptr{mjtNum})
   ccall((:mj_normalizeQuat,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjtNum}),m,qpos)
end

# map from body local to global Cartesian coordinates
function local2Global(d::Ptr{mjData},xpos::Ptr{mjtNum},xmat::Ptr{mjtNum},pos::Ptr{mjtNum},quat::Ptr{mjtNum},body::Integer)
   ccall((:mj_local2Global,:libmujoco141nogl),Void,(Ptr{mjData},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint),d,xpos,xmat,pos,quat,body)
end

# sum all body masses
function getTotalmass(m::Ptr{mjModel})
   ccall((:mj_getTotalmass,:libmujoco141nogl),mjtNum,(Ptr{mjModel},),m)
end

# scale body masses and inertias to achieve specified total mass
function setTotalmass(m::Ptr{mjModel},newmass::mjtNum)
   ccall((:mj_setTotalmass,:libmujoco141nogl),Void,(Ptr{mjModel},mjtNum),m,newmass)
end

# version number: 1.0.2 is encoded as 102 #TODO comment??
function version()
   ccall((:mj_version,:libmujoco141nogl),Cint,())
end
...
function mjv_defaultCamera(cam::Ptr{mjvCamera})
   ccall((:mjv_defaultCamera,:libmujoco141nogl),Void,(Ptr{mjvCamera},),cam)
end

# set default perturbation
function mjv_defaultPerturb(pert::Ptr{mjvPerturb})
   ccall((:mjv_defaultPerturb,:libmujoco141nogl),Void,(Ptr{mjvPerturb},),pert)
end
...
function mjv_room2model(modelpos::Ptr{mjtNum},modelquat::Ptr{mjtNum},roompos::Ptr{mjtNum},roomquat::Ptr{mjtNum},scn::Ptr{mjvScene})
   ccall((:mjv_room2model,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjvScene}),modelpos,modelquat,roompos,roomquat,scn)
end
...
function mjv_model2room(roompos::Ptr{mjtNum},roomquat::Ptr{mjtNum},modelpos::Ptr{mjtNum},modelquat::Ptr{mjtNum},scn::Ptr{mjvScene})
   ccall((:mjv_model2room,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjvScene}),roompos,roomquat,modelpos,modelquat,scn)
end

# get camera info in model space: average left and right OpenGL cameras
function mjv_cameraInModel(headpos::Ptr{mjtNum},forward::Ptr{mjtNum},scn::Ptr{mjvScene})
   ccall((:mjv_cameraInModel,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjvScene}),headpos,forward,scn)
end

# get camera info in room space: average left and right OpenGL cameras
function mjv_cameraInRoom(headpos::Ptr{mjtNum},forward::Ptr{mjtNum},scn::Ptr{mjvScene})
   ccall((:mjv_cameraInRoom,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjvScene}),headpos,forward,scn)
end

# get frustum height at unit distance from camera; average left and right OpenGL cameras
function mjv_frustumHeight(scn::Ptr{mjvScene})
   ccall((:mjv_frustumHeight,:libmujoco141nogl),mjtNum,(Ptr{mjvScene},),scn)
end

# rotate 3D vec in horizontal plane by angle between (0,1) and (forward_x,forward_y)
function mjv_alignToCamera(res::Ptr{mjtNum},vec::Ptr{mjtNum},forward::Ptr{mjtNum})
   ccall((:mjv_alignToCamera,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum}),res,vec,forward)
end
...
function mjv_moveCamera(m::Ptr{mjModel},action::Integer,reldx::mjtNum,reldy::mjtNum,scn::Ptr{mjvScene},cam::Ptr{mjvCamera})
   ccall((:mjv_moveCamera,:libmujoco141nogl),Void,(Ptr{mjModel},Cint,mjtNum,mjtNum,Ptr{mjvScene},Ptr{mjvCamera}),m,action,reldx,reldy,scn,cam)
end
...
function mjv_movePerturb(m::Ptr{mjModel},d::Ptr{mjData},action::Integer,reldx::mjtNum,reldy::mjtNum,scn::Ptr{mjvScene},pert::Ptr{mjvPerturb})
   ccall((:mjv_movePerturb,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Cint,mjtNum,mjtNum,Ptr{mjvScene},Ptr{mjvPerturb}),m,d,action,reldx,reldy,scn,pert)
end

# move model with mouse; action is mjtMouse
function mjv_moveModel(m::Ptr{mjModel},action::Integer,reldx::mjtNum,reldy::mjtNum,roomup::Ptr{mjtNum},scn::Ptr{mjvScene})
   ccall((:mjv_moveModel,:libmujoco141nogl),Void,(Ptr{mjModel},Cint,mjtNum,mjtNum,Ptr{mjtNum},Ptr{mjvScene}),m,action,reldx,reldy,roomup,scn)
end

# copy perturb pos,quat from selected body; set scale for perturbation
function mjv_initPerturb(m::Ptr{mjModel},d::Ptr{mjData},scn::Ptr{mjvScene},pert::Ptr{mjvPerturb})
   ccall((:mjv_initPerturb,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvScene},Ptr{mjvPerturb}),m,d,scn,pert)
end
...
function mjv_applyPerturbPose(m::Ptr{mjModel},d::Ptr{mjData},pert::Ptr{mjvPerturb},flg_paused::Integer)
   ccall((:mjv_applyPerturbPose,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvPerturb},Cint),m,d,pert,flg_paused)
end

# set perturb force,torque in d->xfrc_applied, if selected body is dynamic
function mjv_applyPerturbForce(m::Ptr{mjModel},d::Ptr{mjData},pert::Ptr{mjvPerturb})
   ccall((:mjv_applyPerturbForce,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvPerturb}),m,d,pert)
end
...
function mjv_defaultOption(opt::Ptr{mjvOption})
   ccall((:mjv_defaultOption,:libmujoco141nogl),Void,(Ptr{mjvOption},),opt)
end

# allocate and init abstract scene
function mjv_makeScene(scn::Ptr{mjvScene},maxgeom::Integer)
   ccall((:mjv_makeScene,:libmujoco141nogl),Void,(Ptr{mjvScene},Cint),scn,maxgeom)
end

# free abstract scene
function mjv_freeScene(scn::Ptr{mjvScene})
   ccall((:mjv_freeScene,:libmujoco141nogl),Void,(Ptr{mjvScene},),scn)
end
...
function mjv_updateScene(m::Ptr{mjModel},d::Ptr{mjData},opt::Ptr{mjvOption},pert::Ptr{mjvPerturb},cam::Ptr{mjvCamera},catmask::Integer,scn::Ptr{mjvScene})
   ccall((:mjv_updateScene,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvOption},Ptr{mjvPerturb},Ptr{mjvCamera},Cint,Ptr{mjvScene}),m,d,opt,pert,cam,catmask,scn)
end
...
function mjv_addGeoms(m::Ptr{mjModel},d::Ptr{mjData},opt::Ptr{mjvOption},pert::Ptr{mjvPerturb},catmask::Integer,scn::Ptr{mjvScene})
   ccall((:mjv_addGeoms,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvOption},Ptr{mjvPerturb},Cint,Ptr{mjvScene}),m,d,opt,pert,catmask,scn)
end

# update camera only
function mjv_updateCamera(m::Ptr{mjModel},d::Ptr{mjData},cam::Ptr{mjvCamera},scn::Ptr{mjvScene})
   ccall((:mjv_updateCamera,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjData},Ptr{mjvCamera},Ptr{mjvScene}),m,d,cam,scn)
end
...
function mjr_defaultContext(con::Ptr{mjrContext})
   ccall((:mjr_defaultContext,:libmujoco141nogl),Void,(Ptr{mjrContext},),con)
end

# allocate resources in custom OpenGL context; fontscale is mjtFontScale
function mjr_makeContext(m::Ptr{mjModel},con::Ptr{mjrContext},fontscale::Integer)
   ccall((:mjr_makeContext,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjrContext},Cint),m,con,fontscale)
end

# free resources in custom OpenGL context, set to default
function mjr_freeContext(con::Ptr{mjrContext})
   ccall((:mjr_freeContext,:libmujoco141nogl),Void,(Ptr{mjrContext},),con)
end

# (re) upload texture to GPU
function mjr_uploadTexture(m::Ptr{mjModel},con::Ptr{mjrContext},texid::Integer)
   ccall((:mjr_uploadTexture,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjrContext},Cint),m,con,texid)
end

# (re) upload mesh to GPU
function mjr_uploadMesh(m::Ptr{mjModel},con::Ptr{mjrContext},meshid::Integer)
   ccall((:mjr_uploadMesh,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjrContext},Cint),m,con,meshid)
end

# (re) upload height field to GPU
function mjr_uploadHField(m::Ptr{mjModel},con::Ptr{mjrContext},hfieldid::Integer)
   ccall((:mjr_uploadHField,:libmujoco141nogl),Void,(Ptr{mjModel},Ptr{mjrContext},Cint),m,con,hfieldid)
end
...
function mjr_setBuffer(framebuffer::Integer,con::Ptr{mjrContext})
   ccall((:mjr_setBuffer,:libmujoco141nogl),Void,(Cint,Ptr{mjrContext}),framebuffer,con)
end
...
function mjr_readPixels(rgb::Ptr{Cuchar},depth::Ptr{Cfloat},viewport::mjrRect,con::Ptr{mjrContext})
   ccall((:mjr_readPixels,:libmujoco141nogl),Void,(Ptr{Cuchar},Ptr{Cfloat},mjrRect,Ptr{mjrContext}),rgb,depth,viewport,con)
end
...
function mjr_drawPixels(rgb::Ptr{Cuchar},depth::Ptr{Cfloat},viewport::mjrRect,con::Ptr{mjrContext})
   ccall((:mjr_drawPixels,:libmujoco141nogl),Void,(Ptr{Cuchar},Ptr{Cfloat},mjrRect,Ptr{mjrContext}),rgb,depth,viewport,con)
end
...
function mjr_blitBuffer(src::mjrRect,dst::mjrRect,flg_color::Integer,flg_depth::Integer,con::Ptr{mjrContext})
   ccall((:mjr_blitBuffer,:libmujoco141nogl),Void,(mjrRect,mjrRect,Cint,Cint,Ptr{mjrContext}),src,dst,flg_color,flg_depth,con)
end

# draw text at (x,y) in relative coordinates; font is mjtFont
function mjr_text(font::Integer,txt::String,con::Ptr{mjrContext},x::Cfloat,y::Cfloat,r::Cfloat,g::Cfloat,b::Cfloat)
   ccall((:mjr_text,:libmujoco141nogl),Void,(Cint,Cstring,Ptr{mjrContext},Cfloat,Cfloat,Cfloat,Cfloat,Cfloat),font,txt,con,x,y,r,g,b)
end
...
function mjr_overlay(font::Integer,gridpos::Integer,viewport::mjrRect,overlay::String,overlay2::String,con::Ptr{mjrContext})
   ccall((:mjr_overlay,:libmujoco141nogl),Void,(Cint,Cint,mjrRect,Cstring,Cstring,Ptr{mjrContext}),font,gridpos,viewport,overlay,overlay2,con)
end

# get maximum viewport for active buffer
function mjr_maxViewport(con::Ptr{mjrContext})
   ccall((:mjr_maxViewport,:libmujoco141nogl),mjrRect,(Ptr{mjrContext},),con)
end

# draw rectangle
function mjr_rectangle(viewport::mjrRect,r::Cfloat,g::Cfloat,b::Cfloat,a::Cfloat)
   ccall((:mjr_rectangle,:libmujoco141nogl),Void,(mjrRect,Cfloat,Cfloat,Cfloat,Cfloat),viewport,r,g,b,a)
end

# draw lines
function mjr_lines(viewport::mjrRect,nline::Integer,rgb::Ptr{Cfloat},npoint::Ptr{Cint},data::Ptr{mjtNum})
   ccall((:mjr_lines,:libmujoco141nogl),Void,(mjrRect,Cint,Ptr{Cfloat},Ptr{Cint},Ptr{mjtNum}),viewport,nline,rgb,npoint,data)
end

# 3D rendering
function mjr_render(viewport::mjrRect,scn::Ptr{mjvScene},con::Ptr{mjrContext})
   ccall((:mjr_render,:libmujoco141nogl),Void,(mjrRect,Ptr{mjvScene},Ptr{mjrContext}),viewport,scn,con)
end
...
function mjr_select(viewport::mjrRect,scn::Ptr{mjvScene},con::Ptr{mjrContext},mousex::Integer,mousey::Integer,pos::Ptr{mjtNum},depth::Ptr{mjtNum})
   ccall((:mjr_select,:libmujoco141nogl),Cint,(mjrRect,Ptr{mjvScene},Ptr{mjrContext},Cint,Cint,Ptr{mjtNum},Ptr{mjtNum}),viewport,scn,con,mousex,mousey,pos,depth)
end

# call glFinish
function mjr_finish()
   ccall((:mjr_finish,:libmujoco141nogl),Void,())
end

# call glGetError and return result
function mjr_getError()
   ccall((:mjr_getError,:libmujoco141nogl),Cint,())
end
...
function mju_zero(res::Ptr{mjtNum},n::Integer)
   ccall((:mju_zero,:libmujoco141nogl),Void,(Ptr{mjtNum},Cint),res,n)
end

# copy vector
function mju_copy(res::Ptr{mjtNum},data::Ptr{mjtNum},n::Integer)
   ccall((:mju_copy,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Cint),res,data,n)
end

# scale vector
function mju_scl(res::Ptr{mjtNum},vec::Ptr{mjtNum},scl::mjtNum,n::Integer)
   ccall((:mju_scl,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},mjtNum,Cint),res,vec,scl,n)
end

# add vectors
function mju_add(res::Ptr{mjtNum},vec1::Ptr{mjtNum},vec2::Ptr{mjtNum},n::Integer)
   ccall((:mju_add,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint),res,vec1,vec2,n)
end

# subtract vectors
function mju_sub(res::Ptr{mjtNum},vec1::Ptr{mjtNum},vec2::Ptr{mjtNum},n::Integer)
   ccall((:mju_sub,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint),res,vec1,vec2,n)
end

# add to vector
function mju_addTo(res::Ptr{mjtNum},vec::Ptr{mjtNum},n::Integer)
   ccall((:mju_addTo,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Cint),res,vec,n)
end

# add scaled to vector
function mju_addToScl(res::Ptr{mjtNum},vec::Ptr{mjtNum},scl::mjtNum,n::Integer)
   ccall((:mju_addToScl,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},mjtNum,Cint),res,vec,scl,n)
end

# res = vec1 + scl*vec2
function mju_addScl(res::Ptr{mjtNum},vec1::Ptr{mjtNum},vec2::Ptr{mjtNum},scl::mjtNum,n::Integer)
   ccall((:mju_addScl,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},mjtNum,Cint),res,vec1,vec2,scl,n)
end

# normalize vector, return length before normalization
function mju_normalize(res::Ptr{mjtNum},n::Integer)
   ccall((:mju_normalize,:libmujoco141nogl),mjtNum,(Ptr{mjtNum},Cint),res,n)
end

# compute vector length (without normalizing)
function mju_norm(res::Ptr{mjtNum},n::Integer)
   ccall((:mju_norm,:libmujoco141nogl),mjtNum,(Ptr{mjtNum},Cint),res,n)
end

# vector dot-product
function mju_dot(vec1::Ptr{mjtNum},vec2::Ptr{mjtNum},n::Integer)
   ccall((:mju_dot,:libmujoco141nogl),mjtNum,(Ptr{mjtNum},Ptr{mjtNum},Cint),vec1,vec2,n)
end

# multiply matrix and vector
function mju_mulMatVec(res::Ptr{mjtNum},mat::Ptr{mjtNum},vec::Ptr{mjtNum},nr::Integer,nc::Integer)
   ccall((:mju_mulMatVec,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint),res,mat,vec,nr,nc)
end
...
function mju_mulMatTVec(res::Ptr{mjtNum},mat::Ptr{mjtNum},vec::Ptr{mjtNum},nr::Integer,nc::Integer)
   ccall((:mju_mulMatTVec,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint),res,mat,vec,nr,nc)
end

# transpose matrix
function mju_transpose(res::Ptr{mjtNum},mat::Ptr{mjtNum},r::Integer,c::Integer)
   ccall((:mju_transpose,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Cint,Cint),res,mat,r,c)
end

# multiply matrices
function mju_mulMatMat(res::Ptr{mjtNum},mat1::Ptr{mjtNum},mat2::Ptr{mjtNum},r1::Integer,c1::Integer,c2::Integer)
   ccall((:mju_mulMatMat,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint,Cint),res,mat1,mat2,r1,c1,c2)
end
...
function mju_mulMatMatT(res::Ptr{mjtNum},mat1::Ptr{mjtNum},mat2::Ptr{mjtNum},r1::Integer,c1::Integer,r2::Integer)
   ccall((:mju_mulMatMatT,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint,Cint),res,mat1,mat2,r1,c1,r2)
end
...
function mju_mulMatTMat(res::Ptr{mjtNum},mat1::Ptr{mjtNum},mat2::Ptr{mjtNum},r1::Integer,c1::Integer,c2::Integer)
   ccall((:mju_mulMatTMat,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint,Cint),res,mat1,mat2,r1,c1,c2)
end
...
function mju_sqrMat(res::Ptr{mjtNum},mat::Ptr{mjtNum},r::Integer,c::Integer,scratch::Ptr{mjtNum},nscratch::Integer)
   ccall((:mju_sqrMat,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Cint,Cint,Ptr{mjtNum},Cint),res,mat,r,c,scratch,nscratch)
end
...
function mju_sqrMatTD(res::Ptr{mjtNum},mat::Ptr{mjtNum},diag::Ptr{mjtNum},r::Integer,c::Integer)
   ccall((:mju_sqrMatTD,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint),res,mat,diag,r,c)
end
...
function mju_cholFactor(mat::Ptr{mjtNum},diag::Ptr{mjtNum},n::Integer,minabs::mjtNum,minrel::mjtNum,correct::Ptr{mjtNum})
   ccall((:mju_cholFactor,:libmujoco141nogl),Cint,(Ptr{mjtNum},Ptr{mjtNum},Cint,mjtNum,mjtNum,Ptr{mjtNum}),mat,diag,n,minabs,minrel,correct)
end
...
function mju_cholBacksub(res::Ptr{mjtNum},mat::Ptr{mjtNum},vec::Ptr{mjtNum},n::Integer,nvec::Integer,phase::Integer)
   ccall((:mju_cholBacksub,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint,Cint,Cint),res,mat,vec,n,nvec,phase)
end

# eigenvalue decomposition of symmetric 3x3 matrix
function mju_eig3(eigval::Ptr{mjtNum},eigvec::Ptr{mjtNum},quat::Ptr{mjtNum},mat::Ptr{mjtNum})
   ccall((:mju_eig3,:libmujoco141nogl),Cint,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum}),eigval,eigvec,quat,mat)
end
...
function mju_muscleFVL(len::mjtNum,vel::mjtNum,lmin::mjtNum,lmax::mjtNum,prm::Ptr{mjtNum})
   ccall((:mju_muscleFVL,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum,mjtNum,mjtNum,Ptr{mjtNum}),len,vel,lmin,lmax,prm)
end
...
function mju_musclePassive(len::mjtNum,lmin::mjtNum,lmax::mjtNum,prm::Ptr{mjtNum})
   ccall((:mju_musclePassive,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum,mjtNum,Ptr{mjtNum}),len,lmin,lmax,prm)
end
...
function mju_pneumatic(len::mjtNum,len0::mjtNum,vel::mjtNum,prm::Ptr{mjtNum},act::mjtNum,ctrl::mjtNum,timestep::mjtNum,jac::Ptr{mjtNum})
   ccall((:mju_pneumatic,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum,mjtNum,Ptr{mjtNum},mjtNum,mjtNum,mjtNum,Ptr{mjtNum}),len,len0,vel,prm,act,ctrl,timestep,jac)
end

# convert contact force to pyramid representation
function mju_encodePyramid(pyramid::Ptr{mjtNum},force::Ptr{mjtNum},mu::Ptr{mjtNum},dim::Integer)
   ccall((:mju_encodePyramid,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint),pyramid,force,mu,dim)
end

# convert pyramid representation to contact force
function mju_decodePyramid(force::Ptr{mjtNum},pyramid::Ptr{mjtNum},mu::Ptr{mjtNum},dim::Integer)
   ccall((:mju_decodePyramid,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{mjtNum},Ptr{mjtNum},Cint),force,pyramid,mu,dim)
end

# integrate spring-damper analytically, return pos(dt)
function mju_springDamper(pos0::mjtNum,vel0::mjtNum,Kp::mjtNum,Kv::mjtNum,dt::mjtNum)
   ccall((:mju_springDamper,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum,mjtNum,mjtNum,mjtNum),pos0,vel0,Kp,Kv,dt)
end

# min function, single evaluation of a and b
function mju_min(a::mjtNum,b::mjtNum)
   ccall((:mju_min,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum),a,b)
end

# max function, single evaluation of a and b
function mju_max(a::mjtNum,b::mjtNum)
   ccall((:mju_max,:libmujoco141nogl),mjtNum,(mjtNum,mjtNum),a,b)
end

# sign function
function mju_sign(x::mjtNum)
   ccall((:mju_sign,:libmujoco141nogl),mjtNum,(mjtNum,),x)
end

# round to nearest integer
function mju_round(x::mjtNum)
   ccall((:mju_round,:libmujoco141nogl),Cint,(mjtNum,),x)
end

# convert type id (mjtObj) to type name
function mju_type2Str(_type::Integer)
   ccall((:mju_type2Str,:libmujoco141nogl),Cstring,(Cint,),_type)
end

# convert type name to type id (mjtObj)
function mju_str2Type(str::String)
   ccall((:mju_str2Type,:libmujoco141nogl),Cint,(Cstring,),str)
end

# warning text
function mju_warningText(warning::Integer,info::Integer)
   ccall((:mju_warningText,:libmujoco141nogl),Cstring,(Cint,Cint),warning,info)
end

# return 1 if nan or abs(x)>mjMAXVAL, 0 otherwise
function mju_isBad(x::mjtNum)
   ccall((:mju_isBad,:libmujoco141nogl),Cint,(mjtNum,),x)
end

# return 1 if all elements are 0
function mju_isZero(vec::Ptr{mjtNum},n::Integer)
   ccall((:mju_isZero,:libmujoco141nogl),Cint,(Ptr{mjtNum},Cint),vec,n)
end

# standard normal random number generator (optional second number)
function mju_standardNormal(num2::Ptr{mjtNum})
   ccall((:mju_standardNormal,:libmujoco141nogl),mjtNum,(Ptr{mjtNum},),num2)
end

# convert from float to mjtNum
function mju_f2n(res::Ptr{mjtNum},vec::Ptr{Cfloat},n::Integer)
   ccall((:mju_f2n,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{Cfloat},Cint),res,vec,n)
end

# convert from mjtNum to float
function mju_n2f(res::Ptr{Cfloat},vec::Ptr{mjtNum},n::Integer)
   ccall((:mju_n2f,:libmujoco141nogl),Void,(Ptr{Cfloat},Ptr{mjtNum},Cint),res,vec,n)
end

# convert from double to mjtNum
function mju_d2n(res::Ptr{mjtNum},vec::Ptr{Cdouble},n::Integer)
   ccall((:mju_d2n,:libmujoco141nogl),Void,(Ptr{mjtNum},Ptr{Cdouble},Cint),res,vec,n)
end

# convert from mjtNum to double
function mju_n2d(res::Ptr{Cdouble},vec::Ptr{mjtNum},n::Integer)
   ccall((:mju_n2d,:libmujoco141nogl),Void,(Ptr{Cdouble},Ptr{mjtNum},Cint),res,vec,n)
end

# insertion sort, increasing order
function mju_insertionSort(list::Ptr{mjtNum},n::Integer)
   ccall((:mju_insertionSort,:libmujoco141nogl),Void,(Ptr{mjtNum},Cint),list,n)
end
