...
struct mjuiThemeSpacing        # UI visualization theme spacing
...
struct mjuiThemeColor          # UI visualization theme color
...
struct mjuiDef
   _type::Cint                   # type (XXXItem); -1: section
